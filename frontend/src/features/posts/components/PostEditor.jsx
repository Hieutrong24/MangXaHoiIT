          ...
          <div className="space-y-5">
            ...
            <div>
              <div className="flex flex-wrap gap-2 mb-2">
                {tags.map((tag) => (
                  ...
                  >
                    #{tag}
                    <button type="button" onClick={() => removeTag(tag)} title="Gỡ tag">
                      <X className="h-3 w-3" />
                    </button>
                  </div>
                ))}
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                ...
                Tệp{attachmentCountByKind.file ? ` (${attachmentCountByKind.file})` : ""}
              </button>
              ...
              >
                ...
                Ảnh{attachmentCountByKind.image ? ` (${attachmentCountByKind.image})` : ""}
              </button>
              ...
              >
                ...
                Video{attachmentCountByKind.video ? ` (${attachmentCountByKind.video})` : ""}
              </button>

              <div className="text-[11px] text-slate-500 ml-1">≤ {MAX_FILE_MB}MB / file</div>
            </div>
            ...
            <div className="flex gap-3 border-b border-white/10 pb-2">
              ...
              <button type="button" onClick={() => insertMarkdown("[text](", ")")} title="Link">
                <LinkIcon className="h-4 w-4 text-green-400 hover:scale-110 transition" />
              </button>
              <button type="button" onClick={() => insertMarkdown("![alt](", ")")} title="Image md">
            ...
            {attachments.length > 0 && (
              <div className="space-y-2">
                <div className="text-xs text-slate-300 font-semibold">Tệp đã đính kèm</div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                {isBusy ? <Loader2 className="animate-spin inline h-4 w-4 mr-2" /> : null}
                {submitLabel}
              </button>
            ...
            <div className="text-[11px] text-slate-500">
              *Lưu ý: file đính kèm sẽ được upload (Cloudinary) ở bước Submit bên page cha.
            </div>
          </div>
        </div>

        {/* RIGHT */}
        {rightPanel ? <aside className="lg:sticky lg:top-4 h-fit">{rightPanel}</aside> : null}
      </div>
    </div>
  );
}